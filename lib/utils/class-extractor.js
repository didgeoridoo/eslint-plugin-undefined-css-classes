    ...
    if (Array.isArray(node.value)) {
      ...
      node.value.forEach(valueNode => {
        if (valueNode.type === 'SvelteText' || valueNode.type === 'Text') {
          // Plain text value
          classes.push(...extractClassesFromString(valueNode.value || valueNode.data));
          ...
          if (valueNode.expression) {
            if (valueNode.expression.type === 'Literal' && typeof valueNode.expression.value === 'string') {
              classes.push(...extractClassesFromString(valueNode.expression.value));
            } else if (valueNode.expression.type === 'TemplateLiteral') {
              classes.push(...extractClassesFromTemplateLiteral(valueNode.expression));
            }
          }
        }
      });
